    ...
    roles : [
        {
            ...
            slug : 'astral',
            role : 'goose',
            short : 'Can send sprit through walls', 
            ...
            image : '/gooses_images/astral.png'
        },
        {
            name : 'Avenger',
            slug : 'avenger',
            ...
            image : '/gooses_images/avenger.png'
        },
        {
            name : 'Bird Watcher',
            slug : 'bird-watcher',
            role : 'goose',
            short : 'You can see through walls with limited version.' ,
            description : 'You can see through walls with limited tunnel vision and see slightly further as well.',
            image: '/gooses_images/bird_watcher.png'
        },
        {
            name : 'Canadian',
            slug : 'canadian',
            ...
            image : '/gooses_images/canadian.png'
        },
        {
            name : 'Canibal',
            slug : 'canibal',
            ...
            image : '/gooses_images/canibal.png'
        },
        {
            name : 'Celebrity',
            slug : 'celebrity',
            ...
            image : '/gooses_images/celebrity.png'
        },
        {
            name : 'Demolitionist',
            slug : 'demolitionist',
            ...
            image : '/gooses_images/demolitionist.png'
        },
        {
            name : 'Dodo',
            slug : 'dodo',
        ...
        },
        {
            ...
            image : '/gooses_images/dueling_dodo.png'
        },
        {
            name : 'Engineer',
            slug : 'engineer',
            ...
            image : '/gooses_images/engineer.png'
        },
        {
            name : 'Esper',
            slug : 'esper',
        ...
        },
        {
            ...
            description : 'The falcon is a neutral role that can kill but can not vent nor sabotage. To win, the falcon must either be among the last 3 and survive for 45 seconds, or to be the last bird standing. The geese can only win by tasks and ducks can only win by sabotages while the falcon is alive. The falcon must skip vote for every meeting.',
            image : '/gooses_images/falcon.png'
        },
        {
            name : 'Hitman',
            slug : 'hitman',
            ...
            image  :'/gooses_images/hitman.png'
        },
        {
            name : 'Invisible',
            slug : 'invisible',
            ...
            image : '/gooses_images/invisible.png'
        },
        {
            name : 'Lobbyist',
            slug : 'lobbyist',
            ...
            description : 'You can ask the people at the meeting to vote you. You need a certain amount of votes to unlock the ability to kill',
            image : '/gooses_images/lobbyist.png',
        },
        {
            name : 'Lovers (goose)',
            slug : 'lovers-g',
            ...
            image : '/gooses_images/lovers.png'
        },
        {
            name : 'Lovers (duck)',
            slug : 'lovers-d',
        ...
        {  
            ...
            image : '/gooses_images/medium.png'
        },
        {
            name : 'Mimic',
            slug : 'mimic',
            role : 'goose',
            short : 'The imposters see you as one of them',
            description : 'The imposters can see your name as red, however you don\'t know who the imposters are',
            image : '/gooses_images/mimic.png'
        },
